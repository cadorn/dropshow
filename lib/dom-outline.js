...
// @source https://github.com/andrewchilds/jQuery.DomOutline/blob/59d7719b6d1b87d0eb73638777a3c9271b4ac7bd/jquery.dom-outline-1.0.js
/**
...
var DomOutline = function (options) {
    ...
    function updateOutlinePosition(e) {
        ...
        if (self.opts.requireContent) {
            if (!jQuery(e.target).html()) {
                return;
            }
        }
